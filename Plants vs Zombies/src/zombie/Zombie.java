...
public class Zombie implements Cloneable {
	...
	/**
	 * This is the default constructor that will be used my majority of the
	 * sub-classes.
	 * 
	 * @param movementSpeed
	 *            the speed of the zombie
	 ...
	 * @param hitThreshold
	 *            the amount of hits the zombie can take
	 * @param name
	 *            the name of the zombie
	 * @param yPos
	 *            the row where the zombie will spawn
	 */
	 ...
	 * 
	 * @param damage
	 *            the damage that the zombie takes.
	 */
	 ...
	 * 
	 * @param hitThreshold
	 *            the amount of hits that the zombie can take.
	 */
	 ...
	 * 
	 * @param currentX
	 *            the new x position of the zombie.
	 */
	 ...
	 * 
	 * @param type
	 *            a String representation of the type of zombie.
	 */
	 ...
	 * 
	 * @param y
	 *            the int of the row for the zombie.
	 */
